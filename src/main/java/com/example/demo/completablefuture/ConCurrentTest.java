...
public class ConCurrentTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CompletableFuture<String> cfQueryFromTest = CompletableFuture.supplyAsync(() -> {
            System.out.println("xxxx");
            return "xxx";
        });

        // 用anyOf合并为一个新的CompletableFuture:
        CompletableFuture<Object> cfQuery = CompletableFuture.anyOf(cfQueryFromSina, cfQueryFrom163,cfQueryFromTest);
